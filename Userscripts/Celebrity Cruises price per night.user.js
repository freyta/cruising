// ==UserScript==
// @name         Celebrity Cruises price per night
// @namespace    http://freyta.net/
// @version      2024-09-08
// @description  Calculate and display price per night. Highlight any deals below $100pp
// @author       Freyta
// @match        https://www.celebritycruises.com/au/*
// @icon         https://www.celebritycruises.com/favicon.ico
// @grant        none
// ==/UserScript==
    ...
    function updatePrices() {
        ...
        rows.forEach((row) => {
            ...
            if (daysText > 0 && priceText > 0) {
                ...
                pricePerNightText.textContent = `$${price_per_night} pp/n`;
